...
assert(/@media \(max-width:\s*1024px\)[\s\S]*?\.case-menu-shell\s*{[\s\S]*?grid-template-columns:\s*34px minmax\(0,\s*1fr\) 34px[\s\S]*?padding:\s*0 26px/.test(css), "Mobile case carousel should reserve side arrow columns and keep approved horizontal padding.");
