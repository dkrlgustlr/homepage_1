...
assert(/@media \(max-width:\s*1024px\)[\s\S]*?\.header-bar\s*{[\s\S]*?overflow:\s*visible/.test(css) && /@media \(max-width:\s*1024px\)[\s\S]*?\.mobile-menu-toggle\s*{[\s\S]*?display:\s*inline-flex/.test(css), "Tablet and mobile headers should keep the consultation pill visible and show a hamburger button.");
